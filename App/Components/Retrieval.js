...
import RetrievalCallout from './RetrievalCallout'
import Styles from './Styles/RetrievalStyles'
...
class Retrieval extends React.Component {
  ...
  *************************************************************/
  ...
  renderMapMarkers (location) {
    ...
    * Customize the callout in ./RetrievalCallout.js
    *************************************************************/

    return (
      <MapView.Marker key={location.title} coordinate={{latitude: location.latitude, longitude: location.longitude}}>
        <RetrievalCallout location={location} onPress={this.calloutPress} />
      </MapView.Marker>
    )
  }
